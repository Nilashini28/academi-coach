...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0D0221,30:1a0533,60:2d1b69,100:0f0c29&height=220&section=header&text=AcademiCoach&fontSize=72&fontColor=ffffff&fontAlignY=40&fontStyle=bold&desc=AI-Powered%20Academic%20Integrity%20%E2%80%94%20Built%20on%20Empathy&descAlignY=62&descSize=17&animation=fadeIn" width="100%"/>

<br/>

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=20&pause=1200&color=A78BFA&center=true&vCenter=true&width=750&lines=Every+other+system+watches+the+exam.;AcademiCoach+watches+the+journey.;Because+the+journey+is+where+it+starts+%E2%80%94;and+where+it+can+be+stopped." alt="Typing animation" />
...
[![Redis](https://img.shields.io/badge/Redis-Event%20Bus-DC382D?style=for-the-badge&logo=redis&logoColor=white)]()
[![MIT License](https://img.shields.io/badge/License-MIT-22C55E?style=for-the-badge)]()

<br/>

> 🏆 **Far Away Hackathon** · Agentic & Autonomous Systems Track
...
Wk 1   ████████████  Engaged, on track
Wk 3   ███████░░░░░  Missed two sessions
Wk 6   █████░░░░░░░  Quiz scores dropping
Wk 9   ███░░░░░░░░░  Disengaged, isolated
Wk 11  █░░░░░░░░░░░  Desperate, withdrawn
Wk 14  ░░░░░░░░░░░░
              ↓
...
It activates for **2–3 hours** at the end of 14 weeks. It sees nothing before the exam. Nothing after it ends.
...
║                                                                            ║
║  ┌─────────────────┐   ┌─────────────────┐   ┌──────────────────────────┐  ║
║  │   🖥️  FRONTEND   │   │  ⚡ BACKEND API  │   │     🤖 AGENT LAYER       │  ║
║  │                 │   │                 │   │                          │  ║
║  │  ⚛️  React + TS  │◄──│  🚀 FastAPI      │◄──│  ┌──────────────────┐   │  ║
║  │  📊 Dashboard    │   │  🔌 WebSocket    │   │  │  🧠 Orchestrator  │   │  ║
║  │  👁️  ExamMonitor  │   │  🔐 JWT Auth     │   │  │  (ReAct Loop)    │   │  ║
║  │  🚨 Escalations  │   │  📡 REST Routes  │   │  └────────┬─────────┘   │  ║
║  └─────────────────┘   └─────────────────┘   │           │              │  ║
║                                               │    ┌──────▼───────┐     │  ║
║                                               │    │  🔍 Agents   │     │  ║
║  ┌────────────────────────────────────────┐   │  ┌─┤  Engagement  │     │  ║
║  │           🧮 ML MODELS                  │   │  │ │  Monitor     │     │  ║
║  │                                        │◄──┤  ├─┤  🎯 Intervene │     │  ║
║  │  🌲 IsolationForest (per-student)       │   │  ├─┤  🛡️  ExamGuard │     │  ║
║  │  📈 BehavioralBaseline (14-wk FP)       │   │  ├─┤  ⚠️  Escalation│     │  ║
║  │  ⚡ RiskClassifier (early warning)      │   │  └─┤  📊 Analytics  │     │  ║
║  └────────────────────────────────────────┘   │    └──────────────┘     │  ║
║                                               └──────────────────────────┘  ║
║  ┌──────────────────────────────────────────────────────────────────────┐   ║
...
| Layer | Icon | Technology | Role |
|---|:---:|---|---|
| **Frontend** | ⚛️ | React 18 + TypeScript | Dashboard, live exam feed, escalation UI |
| **Backend** | 🚀 | FastAPI + WebSocket | REST API, real-time event bus, JWT auth |
| **Agent Layer** | 🤖 | Python agents + ReAct | Perceive → reason → act → replan loop |
| **ML Models** | 🧮 | scikit-learn | Per-student anomaly scoring |
| **Database** | 🐘 | PostgreSQL 16 | 14-week behavioral time-series |
| **Event Bus** | ⚡ | Redis | Live exam event streaming |
| **Model Registry** | 📦 | Filesystem + pickle | Trained isolation forests per student |
...
```
                     ...
                     │           🧠 Orchestrator                 │
                     │                                          │
   📡 Exam event ────►│  👁️  PERCEIVE → 💭 REASON → ⚡ ACT       │
                     │                    │                     │
                     │                    ▼                     │
...
| Phase | Icon | What It Does | Key Tech |
|:---:|:---:|---|---|
...
| **GUARD** | 🛡️ | Context-aware monitoring comparing each student against **their own 14-week behavioral fingerprint** — not a class average | `IsolationForest` per student + `exam_guard_agent.py` |
...
## 🧬 Core Innovation: Behavioral Fingerprinting
...
class StudentIsolationForest:
    ...
    Trained on their own 14-week engagement history.
    Anomaly = deviation from self, not from the class.
    """
    ...
    def score_exam_session(self, live_features: dict) -> AnomalyResult:
        ...
        return AnomalyResult(
            ...
            deviation_from=self.baseline_stats           # full context passed to reviewer
        )
```
...
│   │   ├── 🛡️  exam_guard_agent.py    ← Live anomaly detection
...
> 🟢 App live at `http://localhost:5173` · 📖 API docs at `http://localhost:8000/docs`
...
| Metric | Value |
|:---:|:---:|
| 🎓 Students served globally | **300,000,000+** |
| 💰 Target market size | **$8,500,000,000** |
| ⏰ Signal lead time before incident | **4+ weeks** |
| 🎯 Students showing early signals | **73%** |
| ⚡ Window where competitors operate | **2–3 hours** |
| 📅 Window where AcademiCoach operates | **14 weeks** |
...
*Built with ❤️ for the Far Away Hackathon · Agentic & Autonomous Systems Track*
